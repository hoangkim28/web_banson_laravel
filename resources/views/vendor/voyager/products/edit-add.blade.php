    ...
    <form class="page-content container-fluid form-edit-add" role="form"
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="panel">
                    ...
                    <div class="panel-heading">
                        <h3 class="panel-title">Giới thiệu sơ lượt Sơn</h3>
                ...
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">Thông tin chi tiết Sơn</h3>
                        <div class="panel-actions">
            ...
            <div class="col-md-4">
                ...
                <div class="panel panel panel-bordered panel-warning">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="icon wb-clipboard"></i> Thông tin Sơn</h3>
                        <div class="panel-actions">
                            <a class="panel-action voyager-angle-down" data-toggle="panel-collapse"
                               aria-hidden="true"></a>
                        </div>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label for="slug">Tên trên đường dẫn (để trống để dùng mặc định)</label>
                            @include('voyager::multilingual.input-hidden', [
                                '_field_name'  => 'slug',
                            ...
                            <div class="form-group">
                                ...
                                @if(isset($options->on) && isset($options->off))
                                    <input type="checkbox" name="status" class="{{ $class }}"
                                           data-on="Hiển thị" {!! $checked ? 'checked="checked"' : '' !!}
                                           data-off="Ẩn">
                        ...
                        <div class="form-group">
                            <label for="date_available">Thời gian Sơn sẽ hiển thị tại trang chủ</label>
                ...
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="icon wb-image"></i> Hình, ảnh đại diện Sơn</h3>
                        <div class="panel-actions">
                            <a class="panel-action voyager-angle-down" data-toggle="panel-collapse"
                               aria-hidden="true"></a>
                        </div>
                    ...
                    <div class="panel-body text-center">
                        ...
                        @endif
                        <input type="file" name="avatar" accept="image/*" placeholder="Chọn hình">
                    </div>
                </div>
                <!-- ### SEO CONTENT ### -->
                <div class="panel panel-bordered panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="icon wb-search"></i> Các thộc tính SEO</h3>
                        <div class="panel-actions">
                            <a class="panel-action voyager-angle-down" data-toggle="panel-collapse"
                               aria-hidden="true"></a>
                        </div>
        ...
        @section('submit-buttons')
            <button type="submit" class="btn btn-primary pull-right">
                @if($edit) Cập nhật @else <i class="icon wb-plus-circle"></i> Thêm @endif
            </button>
        @stop
