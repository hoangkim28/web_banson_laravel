        ...
        <div class="field-item">
          ...
          <table border="0" style="border: none" cellpadding="1" cellspacing="1"
            ...
            <tbody style="border: none">
              ...
              <tr>
                <td data-th="Tên sản phẩm" class="text-left">{{$item->name}}</td>
                @php
                $khongchon = '';
                ...
                @endphp
                <td data-th="Màu" style="background-color: {{$item->attributes->color ?? '#ffffff'}}; color:dddddd;">
                  {{$khongchon}}</td>
                <td data-th="Kích thước">{{$item->attributes->unit}}</td>
              ...
              <tr style="border: none">
                ...
                <td>Tạm tính:</td>
                <td class="text-right">{{format(\Cart::getSubTotal())}}đ</td>
              </tr>
              <tr style="border: none">
                <td colspan="4" style="background: none;border-style: none;border: none"></td>
                <td>Tổng tiền:</td>
                <td class="text-right">{{format(\Cart::getTotal())}}đ</td>
              </tr>
            </tbody>
          </table>
          @endif
