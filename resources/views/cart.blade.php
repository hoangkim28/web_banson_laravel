                            ...
                            <table border="0" style="border: none" cellpadding="1" cellspacing="1"
                                ...
                                @foreach(Cart::content() as $item)
                                    <tr>
                                        ...
                                        @endphp
                                        <td data-th="Màu"
                                            style="background-color: {{$item->options->color ?? '#f1f1f1'}};">{{$khongchon}}</td>
                                        ...
                                        <td data-th="Số lượng" class="text-center">
                                            <input type="number" name="{{$item->rowId}}" class="text-center"
                                                   ...
                                                   min="1"
                                                   max="{{$item->model->stock}}" value="{{$item->qty}}"
                                                   style="background: white; width: 100px;">
                                        </td>
                                        <td data-th="Số lượng"><a class="btn-remove" href=""
                                ...
                                <tr style="border: none">
                                    ...
                                    <td><a class="btn-remove-all" href=""
                                           data-id="{{$item->rowId}}">Xóa tất cả </a></td>
                                </tr>
                                <tr style="border: none">
                                    <td colspan="6"
                                        style="background: none;border-style: none;border: none; padding: 15px 10px"></td>
                                </tr>
                                <tr style="border: none">
