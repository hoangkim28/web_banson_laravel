                    ...
                    @if (Route::has('login'))
                        @auth
                            <ul class="nav menu menu-parent">
                                ...
                                <li class="menu-item"><a href="{{ route('logout') }}"  onclick="event.preventDefault(); document.getElementById('frm-logout').submit();">Đăng
                                        xuất</a></li>
            ...
            <div class="navbar navbar-expand-md navbar-dark">
                <div class="navbar-brand header-brand">
                    <div class="region region-branding">
                        <div id="block-wosh-sub-branding"
                             class="site-branding block block-system block-system-branding-block">
                            <div class="top-paint-color hidden"></div>
                            <div class="container-wrap clearfix">
                                <div class="brand logo"><a href="/" title="Trang chủ" rel="home"
                                                           class="site-branding-logo"> <img src="{{asset('images/logo.png')}}"
                                                                                            alt="Trang chủ"> </a></div>
                            </div>
                ...
                <div id="main-menu" class="nip-header__nav primary-navbar collapse navbar-collapse ">
                    <div class="region region-primary-menu">
                        <nav aria-labelledby="block-wosh-sub-main-menu" id="block-wosh-sub-main-menu"
                             class="block block-system">
                            <div class="container-wrap clearfix menu-wrap">
                                <ul class="nav menu menu-parent sm sm-menu" data-smartmenus-id="15956439676389817">
                                    <li class="menu-item menu-item--expanded">
                                        <a href="#main-content" data-drupal-link-system-path="<front>"
                                           class="has-submenu" id="sm-15956439676389817-3" aria-haspopup="true"
                                           aria-controls="sm-15956439676389817-4" aria-expanded="false">Sản phẩm<span
                                                    ...
                                                    @if($category->parent_id == 0)
                                                        <li class="menu-item menu-item--expanded">
                                                            <a href="{{route('product.cate',$category->slug)}}"
                                                               data-drupal-link-system-path="taxonomy/term/36"
                                                               class="has-submenu" id="sm-15956439676389817-5"
                                                               aria-expanded="false">{{$category->name}} @if ($category->children()->count() > 0)
                                                                    <span
                                                                        class="sub-arrow"></span> @endif</a>
                                                            @if ($category->children()->count() > 0)
                                                                <ul class="menu" id="sm-15956439676389817-6"
                                    ...
                                    <li class="menu-item menu-item--expanded">
                                        <a href="#main-content" data-drupal-link-system-path="<front>"
                                           class="has-submenu" id="sm-15956439676389817-7" aria-haspopup="true"
                                           aria-controls="sm-15956439676389817-8" aria-expanded="false">Hỗ trợ<span
                                                class="sub-arrow"></span></a>
                                        <ul class="menu" id="sm-15956439676389817-8" role="group" aria-hidden="true"
                                            ...
                                            <li class="menu-item"><a href="/vi/tinh-toan-luong-son"
                                                                     data-drupal-link-system-path="tinh-toan-luong-son">Tính
                                                    toán lượng sơn</a></li>
                                            <li class="menu-item"><a href="/vi/tin-tuc/meo-son-nha"
                                                                     data-drupal-link-system-path="taxonomy/term/96">Mẹo
                                                    sơn nhà</a></li>
                                            <li class="menu-item"><a href="/vi/ho-tro-phoi-mau"
                                                                     data-drupal-link-system-path="webform/dich_vu_phoi_mau">Hỗ
                                                    trợ phối màu </a></li>
                                        </ul>
                                    </li>
                                ...
                                <div class="menu-mobile">
                                    <ul class="nav menu menu-parent sm sm-menu" data-smartmenus-id="1595643967642667">
                                        <li class="menu-item"><a href="/vi/gioi-thieu"
                                                                 data-drupal-link-system-path="node/1175">Giới thiệu</a>
                                        </li>
                                        <li class="menu-item"><a href="/vi/tin-tuc"
                                                                 data-drupal-link-system-path="tin-tuc">Tin tức</a></li>
                                        <li class="menu-item"><a href="/vi/lien-he"
                                                                 data-drupal-link-system-path="webform/contact">Liên
                                                hệ</a></li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="header-element__icon">
                        <div class="header-element__item search--element">
                            <button type="button" class="header-icon search-icon"
                                    onclick="location = '{{route('product.search')}}'"><span
                                    class="ion-ios-search-strong"></span></button>
                        </div>
                        <div class="header-element__item search--element">
                            <button type="button" class="header-icon search-icon"
                                    onclick="location = '{{route('cart.index')}}'">
                                ...
                                <div
                                    ...
                                    <div class="container-wrap clearfix">
                                        <div class="block-content">
                                            <ul class="links">
                                                    @auth
                                                    <li class="vi is-active"><a
                                                            href="{{ route('auth.manager') }}"
                                                            class="language-link is-active" hreflang="vi"
                                                            data-drupal-link-system-path="node/1916">Quản lý tài khoản</a></li>
                                                    <li class="en"><a
                                                                href="{{ route('logout') }}"  onclick="event.preventDefault(); document.getElementById('frm-logout').submit();"
                                                                class="language-link" hreflang="en"
                                                                data-drupal-link-system-path="node/1916">Đăng xuất </a></li>                                                            
                                                    @else       
                                                        <li class="vi is-active"><a
                                                                href="{{ route('login') }}"
                                                                class="language-link is-active" hreflang="vi"
                                                                data-drupal-link-system-path="node/1916">Đăng nhập </a></li>
                                                        <li class="en"><a
                                                                href="{{ route('register') }}"
                                                                class="language-link" hreflang="en"
